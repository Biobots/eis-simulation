...
namespace tide
{
	...
	public:
		GLuint handle;
		Shader(const char * vertex_file_path,const char * geometry_file_path)
		{
			handle = LoadExternalShaders(vertex_file_path, geometry_file_path);
		}
	...
	public:
		GLuint handle;
		Texture(const char* ptr, size_t size, int width, int height, uchar* data)
		{
